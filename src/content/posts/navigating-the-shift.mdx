...
<Image class="float-right pt-4 pl-4 rounded-sm m-0" src={capabilities} alt="The capabilities phase. Notice that the team will soon discover some troubling things about their spelling..." width="400"/>
...
<Image class="float-left pr-4 pt-4 rounded-sm m-0" src={fear} alt="The fear phase" width="400"/>
