...
This has been the year of generative AI, and what a technology moment is has been. As Mark Twain would say: the LLM revolution happened in two ways, gradually then suddenly. The research has been baking for years, and this year everything fell into place.
...
Video is still early, but coming out of its shell with products like [Pika](https://pika.art/) and [Runway](https://runwayhttps://runwayml.com/). We're starting to see news being personalized for you and delivered via a video feed of a generated human, which you can interact with.
...
<span class="opacity-50 text-xs">
  [_(skip to my predictions)_](#tomorrow-my-predictions)
</span>
...
Some companies have come out with radically innovative hardware. The first of these is [humane's AI pin](https://hu.ma.ne/aipin). I predict we'll see more of these in 2024. Sam Altman is apparently in talks with hardware manifacturers ([and Jonny Ive?](https://www.theinformation.com/articles/designer-jony-ive-and-open-ais-sam-altman-discuss-ai-hardware-project)) to build his own dedicated AI hardware.
...
I'm a techno-optimist, so I couldn't be more excited as we move into 2024. I believe our worl will change more next year than it has any previous year of my career. Open-source will catch up with proprietary modes, and help push inference to (maybe new categories of) edge devices everywhere. AI is going to catalyze competition, productivity, and software is about to disrupt itself.
